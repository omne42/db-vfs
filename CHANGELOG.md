...
- service/audit-runtime: move required-audit ack waits onto the async request path so blocking-pool saturation alone cannot trigger spurious `503 audit_unavailable` responses before append+flush actually starts.
